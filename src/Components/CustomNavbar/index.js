...
const CustomNavbar = (props) => {
  ...
  return (
    <nav className={"navBar"}>
      ...
      <ButtonDropdown className={"dropDwonMwnu"} isOpen={props.isSettingOpen} toggle={onSettingGear}>
          <DropdownToggle style={{ color: "grey" }} color="link">
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-gear-fill" fill="white" xmlns="http://www.w3.org/2000/svg">
          ...
          <DropdownMenu right>
              <DropdownItem onClick={toggleProfileEditModal}>Profile</DropdownItem>
          </DropdownMenu>
      </ButtonDropdown>
    </nav>
  );
